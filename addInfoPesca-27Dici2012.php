...
//echo 	$sql_insert." ----  ".mssql_get_last_message()."<br>";
			...
			$sql_insert2= $sql_insert2. " ".$temporalidad."," ;
...
?>
      ...
      <tr>
                ...
                <td><input name="cantidad" type="text" class="CajaTexto" id="cantidad"  onKeyPress="return acceptNum(event)" > </td>
      </tr>  
      <tr>
                <td><span class="TxtTabla">6.8.3.4 % autoconsumo</span></td>
                <td> <input name="auto" type="text" class="CajaTexto" id="auto"  onKeyPress="return acceptNum(event)" > </td>
      </tr>  
      <tr>
                <td><span class="TxtTabla">6.8.3.5 % venta</span></td>
                <td><input name="venta" type="text" class="CajaTexto" id="venta"  onKeyPress="return acceptNum(event)" ></td>
      </tr>  
      <tr>
...
?>
                    <select name="temporalidad" class="CajaTexto" id="temporalidad" >
						<option value="">Seleccione una temporalidad</option>
<?php 
						while($datos_tempo=mssql_fetch_array($cur_tempo))
						{
?>
						<option value="<?php echo $datos_tempo["codItem"]; ?>"><?php echo $datos_tempo["nomItem"]; ?></option>
<?							
						}
?>
                    </select>
