...
//		  if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 4) OR ($_SESSION["ccfUsuPerfil"] == 13) OR ($_SESSION["ccfUsuPerfil"] == 18)) 		{ 
        ...
        <td width="2%" class="TxtTabla"><a href="#"><img src="../images/del.gif" alt="Eliminar Unidad Social" width="14" height="13" border="0" onClick="MM_openBrWindow('upViviendas.php?accion=3&v=<?=$reg0[nroVivienda];?>','vAF','scrollbars=yes,resizable=yes,width=850,height=300')"></a></td>      
      </tr>
     <? } ?> 
    </table>
