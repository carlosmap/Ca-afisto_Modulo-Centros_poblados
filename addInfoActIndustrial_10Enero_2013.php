...
/*
	var can_item=document.form1.reg.value;
	var can_selec=0;
	for(var i=1;i<=can_item;i++)
	{
		window['maquinarias']='maquinaria'+i; 
		//valida cuales estan marcados con la opcion NO

		if(document.getElementById(maquinarias).checked)
		{
...
?>
                  ...
                  <tr>
                    ...
                    <td class="TxtTabla">Si<input type="radio" name="rut" id="rut" value="1"  onChange="campRut('si')"> 
                  ...
                  <tr>
                    ...
                    <td class="TxtTabla"><input type="text" name="cod_rut" id="cod_rut"  class="CajaTexto" onKeyPress="return acceptNum(event)" disabled></td>
                  </tr>
                  <tr>
