...
function Genera_Tabla_Cantidad($T,$Sum,$Pag,$tipo,$Decimal)
{
	//Obtener Titulo y/o Pregunta de la Sección
	//dbo.tmOpciones
	//codProyecto, codModulo, codOpcion, nomOpcion, pregunta, esVisible, fechaGraba, usuarioGraba, fechaMod, usuarioMod
...
//echo $sqlRta." -- ".mssql_get_last_message()."<br>";	
	...
	<? if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 3)) 	
		{ 	if (mssql_num_rows($cursorRta) == 0) 
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addCSCPFichaInfoCant.php?Opc=<? echo $T;?>&Sum=<? echo $Sum;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&Decimal=<? echo $Decimal; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Nuevo">
		 <? } 
			else
			{ ?>
...
<?php
	...
	<?php
			...
			if($T==111)
			{
				...
				$cur_pregun_si=mssql_query("select * from tmItems where codOpcion in (127) ");
 ...
 <? 
	...
	<? if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 3)) 	
		{ 	
			...
			if (mssql_num_rows($cursorRta) == 0) 
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addCSCPFichaInfoText_p.php?Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>&subP2=<? echo $subP2; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Nuevo">
		 <? } 
			else
			{ 
				if($T!=111)
...
?>
			...
			<? 
				...
				{
?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoText_2.php?accion=2&Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>&subP2=<? echo $subP2; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Editar">
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoText_2.php?accion=3&Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>&subP2=<? echo $subP2; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Eliminar">	
