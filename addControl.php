...
//alert  ("mes "+fch[0]+" dia "+ fch[1]+" ano"+ fch[2]+ " ano actual "+a);
		if( ( parseInt( fch[0] ) > 12 ) || ( parseInt(fch[1]) > 31 ) || ( parseInt(fch[2]) > a ) ){
			v6 = 'n';
  ...
  <tr>
	...
	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
	  ...
	  <tr>
	    ...
	    <td class="TxtTabla">
        <input type="text" name="fch<?= $r ?>" id="fch<?= $r ?>" class="CajaTexto" size="20" onKeyPress="formato( 1, this );  return acceptNum(event);" maxlength="10" value="<?= $fch ?>" />
        (mm/dd/aaaa) 
        </td>
	    <td class="TxtTabla">
        <input type="text" name="hr<?= $r ?>" id="hr<?= $r ?>" class="CajaTexto" size="20" onKeyPress="formato( 2, this ); return acceptNum(event);" maxlength="5" value="<?= $hr ?>" />
        (hh:mm) 
		</td>
	    <td class="TxtTabla">
