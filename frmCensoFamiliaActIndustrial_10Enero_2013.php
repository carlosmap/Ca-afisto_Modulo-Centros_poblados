...
?>					
				...
				<td><?php echo $datos_sel["unidadMedida"]; ?></td> 
...
?>
                    ...
                    <td><a href="#"><img src="http://www.ingetec.com.co/sistemas/sisCanafisto/images/actualizar2.gif" alt="Editar" border="0" onClick="MM_openBrWindow('upInfoActIndustrial.php?accion=2&conse=<?=$datos_sel["consecAct"];?>','vAF','scrollbars=yes,resizable=yes,width=700,height=400')" /> </a></td>

                    <td><a href="#"> <img src="http://www.ingetec.com.co/sistemas/sisCanafisto/images/del.gif" alt="Eliminar" border="0" onClick="MM_openBrWindow('upInfoActIndustrial.php?accion=3&conse=<?=$datos_sel["consecAct"];?>','vAF','scrollbars=yes,resizable=yes,width=700,height=400')" /></a></td>
<?php 				}
					else
						echo "<td></td> <td></td>";
?>
...
?>			
				...
				<? if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 3)) 	
                    {
?>
					<input name="nuevo" type="button" class="Boton"  id="nuevo" value="Nuevo"  onClick="MM_openBrWindow('addInfoActIndustrial.php','vAF','scrollbars=yes,resizable=yes,width=780,height=350')">
<?
					}
//****************************************************************************/
