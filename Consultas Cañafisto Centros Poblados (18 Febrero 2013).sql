...
WHERE     (CSCPFichaInfoBoolean.respItem = 1) AND (CSCPFichaInfoBoolean.codOpcion IN (6))
...
WHERE     (CSCPFichaInfoCant.codOpcion IN (131)) AND (CSCPFichaInfoCant.codModulo = 1) AND (CSCPFichaInfoCant.codProyecto = 5)
...
WHERE     (CSCPFichaInfoCant.codOpcion IN (25)) AND (CSCPFichaInfoCant.codModulo = 1) AND (CSCPFichaInfoCant.codProyecto = 5)
