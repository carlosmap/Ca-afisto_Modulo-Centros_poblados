...
function Genera_Tabla_Cantidad($T,$Sum,$Pag,$tipo)
{
	//Obtener Titulo y/o Pregunta de la Sección
	//dbo.tmOpciones
	//codProyecto, codModulo, codOpcion, nomOpcion, pregunta, esVisible, fechaGraba, usuarioGraba, fechaMod, usuarioMod
...
//echo $sqlRta." -- ".mssql_get_last_message()."<br>";	
	...
	<? if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 3)) 	
		{ 	if (mssql_num_rows($cursorRta) == 0) 
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addCSCPFichaInfoCant.php?Opc=<? echo $T;?>&Sum=<? echo $Sum;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Nuevo">
		 <? } 
			else
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoCant.php?accion=2&Opc=<? echo $T;?>&Sum=<? echo $Sum;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Editar">
...
<?php
		...
		{
			$cur_pregun_si=mssql_query("select * from tmOpciones where codOpcion in (121,122)");
?>
        <tr class="TxtTabla">
        	<td>
        	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
...
?>
 ...
 <? 
	...
	<? if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 3)) 	
		{ 	if (mssql_num_rows($cursorRta) == 0) 
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addCSCPFichaInfoText.php?Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>&subP2=<? echo $subP2; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Nuevo">
		 <? } 
			else
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoText.php?accion=2&Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>&subP2=<? echo $subP2; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Editar">
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoText.php?accion=3&Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>&subP2=<? echo $subP2; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Eliminar">				
			<? }
	}	 ?>
		</td>
      </tr>
...
//echo $sqlOpcionD." -- ".$T1." -- ".mssql_get_last_message();
 ...
 <? } ?>
	...
	<? if (($_SESSION["ccfUsuPerfil"] == 1) OR ($_SESSION["ccfUsuPerfil"] == 2) OR ($_SESSION["ccfUsuPerfil"] == 3)) 	
		{ 	if (mssql_num_rows($cursorRta) == 0) 
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('addCSCPFichaInfoText.php?Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Nuevo">
		 <? } 
			else
			{ ?>
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoText.php?accion=2&Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Editar">
			<input name="Submit" type="button" class="Boton" onClick="MM_openBrWindow('upCSCPFichaInfoText.php?accion=3&Opc=<? echo $T;?>&Opc1=<? echo $T1;?>&pag=<? echo $Pag;?>&tipo=<? echo $tipo;?>&subP1=<? echo $subP1; ?>','vAF','scrollbars=yes,resizable=yes,width=780,height=300')" value="Eliminar">				
			<? }
	}	 ?>
		</td>
      </tr>
...
//consulta si el formulario contiene registros, asociados en CSCPFichaInfoBooleanM
	...
	$sqlRta2="SELECT * FROM tmSubItems where codProyecto=".$_SESSION["ccfProyecto"]." and codModulo=".$_SESSION["ccfModulo"]." and codOpcion=".$T2;
	$cursorRta2 = mssql_query($sqlRta2);
...
//echo $sqlNom." -- ".mssql_get_last_message()."<br>";
	...
	<table width="100%"  border="0" cellspacing="1" cellpadding="0">
	  ...
	  ?>
	  <tr class="TxtTabla">
	  	<td><? echo $RegRta2[nomSubItem]  ; ?></td>
<?
		$sqlRta3="SELECT CSCPFichaInfoBooleanM.codProyecto, CSCPFichaInfoBooleanM.codModulo, CSCPFichaInfoBooleanM.numFormulario, 
				CSCPFichaInfoBooleanM.nroObjeto, CSCPFichaInfoBooleanM.tipoObjeto, CSCPFichaInfoBooleanM.codOpcion, 
				CSCPFichaInfoBooleanM.codItem,CSCPFichaInfoBooleanM.codSubItem, CSCPFichaInfoBooleanM.respItem, CSCPFichaInfoBooleanM.fechaGraba,
				 CSCPFichaInfoBooleanM.usuarioGraba, CSCPFichaInfoBooleanM.fechaMod, CSCPFichaInfoBooleanM.usuarioMod, 
				 tmSubItems.nomSubItem AS nomPregunta FROM CSCPFichaInfoBooleanM INNER JOIN tmSubItems 
				 ON CSCPFichaInfoBooleanM.codOpcion = tmSubItems.codOpcion AND CSCPFichaInfoBooleanM.codSubItem = tmSubItems.codSubItem ";
